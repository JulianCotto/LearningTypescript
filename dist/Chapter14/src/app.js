    ...
    class ProjectState extends State {
        ...
        updateListeners() {
            for (const listenerFn of this.listeners) {
                listenerFn(this.projects.slice()); // only return a copy of the array, not the array itself
            }
        }
    }
    // single state management object for the project
    ...
    let ProjectItem = (() => {
        ...
        return _a = class ProjectItem extends _classSuper {
                ...
                constructor(hostId, project) {
                    ...
                    this.project = __runInitializers(this, _instanceExtraInitializers);
    ...
    let ProjectInput = (() => {
        ...
        return _a = class ProjectInput extends _classSuper {
                constructor() {
                    ...
                    this.titleInputElement = __runInitializers(this, _instanceExtraInitializers);
